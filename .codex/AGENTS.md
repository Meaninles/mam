...
Project note: default all end-user interface text, prompts, and product copy to Simplified Chinese unless the task explicitly requires another language.
...
- ui-ux-pro-max — Professional UI/UX design intelligence with searchable style, color, typography, and UX guidance
