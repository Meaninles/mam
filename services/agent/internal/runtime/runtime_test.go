...
func TestBuildSummaryIncludesRequiredFields(t *testing.T) {
	...
	expected := `{"agentId":"agent-dev-1","version":"dev","hostname":"工作站-A","platform":"windows/amd64","mode":"attached","processId":1024,"capabilities":["localfs"],"startedAt":"2026-04-08T12:00:00Z"}`
